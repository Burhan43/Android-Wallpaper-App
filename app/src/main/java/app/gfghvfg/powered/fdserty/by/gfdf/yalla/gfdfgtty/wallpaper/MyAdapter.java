...
public class MyAdapter extends RecyclerView.Adapter<WallpaperViewHolder> {

    private Context context;
    private List<Model> wallpaperModelList;

    public MyAdapter(Context context, List<Model> wallpaperModelList) {
